    ...
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <!-- Chart 2: Persebaran Siswa & Kelas per Tingkatan (Bar Chart) -->
            <div class="lg:col-span-7 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-1">
                        <h4 class="text-base font-bold text-gray-900">Statistik Siswa & Kelas per Tingkat</h4>
                        <span class="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-100 text-indigo-700">Jenjang Tingkat</span>
                    </div>
                    <p class="text-xs text-gray-500">Distribusi jumlah siswa aktif dan kelas di tiap tingkatan.</p>
                </div>
                ...
                <div class="pt-3 border-t border-gray-100 flex flex-wrap items-center justify-between gap-2 text-xs text-gray-500">
                    <span class="flex items-center gap-2">
                        ...
                        <span class="w-3 h-3 rounded bg-amber-400 ml-2"></span> Jumlah Kelas
                    </span>
                    <a href="{{ route('kelas.index') }}" class="text-indigo-600 font-bold hover:underline">Lihat Kelas &rarr;</a>
                </div>
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // 2. Inisialisasi Bar Chart Persebaran Siswa & Kelas
